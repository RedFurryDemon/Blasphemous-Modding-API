...
namespace ExampleMod1
{
	...
	public class ExampleMod1 : Mod
	{
		...
		protected override void PreInitialize()
		{
			...
			Logger.LogVerbose("[Example Mod 1] This text should appear on pre-initialize");
		}
		...
		protected override void Initialize()
		{
			...
			Logger.LogVerbose("[Example Mod 1] This text should appear on initialize");
		}
		...
		protected override void PostInitialize()
		{
			...
			Logger.LogVerbose("[Example Mod 1] This text should appear on post-initialize");
		}
